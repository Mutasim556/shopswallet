<?php return array (
  ...
  'add_on_category' => 'Add on category',
  'add_on_price' => 'Add on price',
  'add_new_add_on_category' => 'Add new add on category',
  'Add new add on category' => 'Add new add on category',
  'general_category_section' => 'General category section',
  'CITY SECTION' => 'CITY SECTION',
  'city_section' => 'City section',
  'City' => 'City',
  ...
  'time_slot_section' => 'Time slot section',
  'time_slot_&_date' => 'Time slot & date',
  'timeslot_section' => 'Timeslot section',
  'edit_city' => 'Edit city',
  'message.city' => 'Message.city',
  'Update city' => 'Update city',
  'city_title' => 'City title',
  'message.city_update' => 'Message.city update',
  'city' => 'City',
  'city_updated_successfully' => 'City updated successfully',
  'message.select_category' => 'Message.select category',
  'Select Category' => 'Select Category',
  'message.current_or_next_date?' => 'Message.current or next date ',
  'current_or_next_date?' => 'Current or next date ',
  'message.date_+_day' => 'Message.date + day',
  'date_+_day' => 'Date + day',
  'message.timeslot_list' => 'Message.timeslot list',
  ...
  'add_time_slot_&_date' => 'Add time slot & date',
  'time slot' => 'Time slot',
  'view_time_slot' => 'View time slot',
  'search_timeslots' => 'Search timeslots',
  'ex_:_timeslots' => 'Ex : timeslots',
  'added_days' => 'Added days',
  'Current' => 'Current',
  'Next' => 'Next',
  'time_slot_status_updated' => 'Time slot status updated',
  'edit_timeslot' => 'Edit timeslot',
  'time_slot' => 'Time slot',
  'time_slot_updated_successfully' => 'Time slot updated successfully',
  'lists_time_slot_&_date' => 'Lists time slot & date',
  'view_time_slot_&_date' => 'View time slot & date',
  'selected_sloats' => 'Selected sloats',
  'selected_slots' => 'Selected slots',
  'Want to delete this timeslot' => 'Want to delete this timeslot',
  ...
  'Vendor Cover' => 'Vendor Cover',
  'cendor_information' => 'Cendor information',
  'vendor_information' => 'Vendor information',
  'Vendor List' => 'Vendor List',
  'total_vendors' => 'Total vendors',
  'active_vendors' => 'Active vendors',
  'inactive_vendors' => 'Inactive vendors',
  'newly_joined_vendors' => 'Newly joined vendors',
  'you_want_to_change_this_vendor_status' => 'You want to change this vendor status',
  ...
  'pending_service_list' => 'Pending service list',
  ...
  'Sub-sub-category is required!' => 'Sub-sub-category is required!',
  ...
  'Package details is required!' => 'Package details is required!',
  'default_package_details_is_required' => 'Default package details is required',
  ...
  'package_type_is_required' => 'Package type is required',
  'purchase_type_is_required' => 'Purchase type is required',
  'discount_type_is_required' => 'Discount type is required',
  'validity_is_required' => 'Validity is required',
  'purchase_limit' => 'Purchase limit',
  12 => '12',
  'purchase_limit_time' => 'Purchase limit time',
  'example-30' => 'Example-30',
  'Cant purchase with point?' => 'Cant purchase with point ',
  'Cant gift it?' => 'Cant gift it ',
  'Cant purchase with point ?' => 'Cant purchase with point  ',
  'Cant gift it ?' => 'Cant gift it  ',
  'purchase_limit_time[0 for only 1 time]' => 'Purchase limit time[0 for only 1 time]',
  'type 0 for no limit and type -1 for only once ' => 'Type 0 for no limit and type -1 for only once ',
  'Can purchase with point ?' => 'Can purchase with point  ',
  'Can gift it ?' => 'Can gift it  ',
  'maximum_order_limit' => 'Maximum order limit',
  'maximum_withdraw_per_day' => 'Maximum withdraw per day',
  'Subscription' => 'Subscription',
  'purchase_history' => 'Purchase history',
  'Package1' => 'Package1',
  'this_package_is_free_for_you' => 'This package is free for you',
  'update_your_account_to_access_full_version' => 'Update your account to access full version',
  'unlimited_access' => 'Unlimited access',
  'days_unlimited_access' => 'Days unlimited access',
  'you_can_receive_maximum' => 'You can receive maximum',
  'you_can_purchase_it_only_one_time' => 'You can purchase it only one time',
  'start_free_trail' => 'Start free trail',
  'payment_option' => 'Payment option',
  'select_payment_option' => 'Select payment option',
  'purchase_limit_is_required' => 'Purchase limit is required',
  'purchase_limit_time_is_required' => 'Purchase limit time is required',
  'maximum_order_limit_is_required' => 'Maximum order limit is required',
  'payment_option_is_required' => 'Payment option is required',
  'you_can_purchase_it' => 'You can purchase it',
  'times_per_months' => 'Times per months',
  '_times_per_months' => ' times per months',
  ...
  'plesae_select_one' => 'Plesae select one',
  'Invalid_package' => 'Invalid package',
  'package_activated_successfully' => 'Package activated successfully',
  'already_purchased' => 'Already purchased',
  'purchase_list' => 'Purchase list',
  'search_purchases' => 'Search purchases',
  'ex_:_purchases' => 'Ex : purchases',
  'paid_amount' => 'Paid amount',
  'purchase_date' => 'Purchase date',
  'expiry_date' => 'Expiry date',
  'Details' => 'Details',
  'maximum_order_limit_' => 'Maximum order limit ',
  'remaining_balanace' => 'Remaining balanace',
  'Orders( ' => 'Orders( ',
  'Orders ' => 'Orders ',
  'activated' => 'Activated',
  'please_wait .....' => 'Please wait .....',
  'you_have_reached_your_purchased_limit' => 'You have reached your purchased limit',
  'you_have_already_a_pending_request' => 'You have already a pending request',
  'Your_request_was_sent_Please_wait_for_approval' => 'Your request was sent Please wait for approval',
  'Your_request_was_sent_Please_wait_untill_we_contact_with_you' => 'Your request was sent Please wait untill we contact with you',
  ...
  'select_one_please' => 'Select one please',
  'manufacturer' => 'Manufacturer',
  'select_brands' => 'Select brands',
  'vendor type updated successfully!' => 'Vendor type updated successfully!',
  'my_stores' => 'My stores',
  'vendor type updated success!' => 'Vendor type updated success!',
  'wholesellers' => 'Wholesellers',
  'update_vedor_type' => 'Update vedor type',
