...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <form action="javascript:" method="post" id="product_form" enctype="multipart/form-data">
            ...
            <div class="row g-2">
                <input type="hidden" class="route_url" value="{{ route('admin.item.update', [$product['item_id']]) }}">
                                            ...
                                            <div class="form-group mb-0">
                                                <label class="input-label"
                                                    for="exampleFormControlSelect1">{{ translate('messages.sub_category') }}<span
                                                        class="input-label-secondary"></span></label>
                                                <input type="hidden" name="sub_category_id" value="{{ $product->product_sub_category_id }}">
                                            ...
                                            <div class="form-group mb-0">
                                                <label class="input-label"
                                                    for="exampleFormControlSelect1">{{ translate('messages.child_category') }}<span
                                                        class="input-label-secondary"></span></label>
                                                <input type="hidden" name="sub_sub_category_id" value="{{ $product->product_sub_sub_category_id }}">
                                                <select name="" id="sub-sub-categories"
                                                    class="form-control js-select2-custom" disabled
                                                    onchange="getItems('{{ url('/') }}/store-panel/item/get-items?parent_id='+this.value,'item_id')" >
                                                    <option value="{{ $product->product_sub_sub_category_id }}" selected>
                                ...
                                <div class="row g-2">
                                    ...
                                    @if (Config::get('module.current_module_type') != 'services' && Config::get('module.current_module_type') != 'booking')
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="form-group mb-0">
                                                <label class="input-label"
                                                    for="store_id">{{ translate('messages.store') }}<span
                                                        class="input-label-secondary"></span></label>
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="form-group mb-0">
                                                ...
                                                <select name="category_id" class="js-data-example-ajax form-control"
                                                    id="category_id" onchange="categoryChange(this.value)">
                                                    @if ($category)
                                                        <option value="{{ $category->parent()->first()['id'] }}">
                                                            {{ $category->parent()->first()['name'] }}</option>
                                                    @endif
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="form-group mb-0">
                                                <label class="input-label"
                                                    for="child_categories">{{ translate('messages.child_category') }}<span
                                                        class="input-label-secondary"
                                                        title="{{ translate('messages.category_required_warning') }}"><img
                                                            src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                                                            alt="{{ translate('messages.category_required_warning') }}"></span></label>
                                        ...
                                        <div class="form-group mb-0">
                                            ...
                                            <select name="condition_id" id="condition_id"
                                                ...
                                                @if (isset($product->pharmacy_item_details?->common_condition_id))
                                                    <option
                                                        value="{{ $product->pharmacy_item_details->common_condition_id }}"
                                                        selected="selected">
                                                        {{ $product->pharmacy_item_details?->common_condition->name }}
                                                    </option>
                                                @elseif(isset($temp_product) && $temp_product == 1 && $product->common_condition_id)
                                                    <option value="{{ $product->common_condition_id }}"
                                                        selected="selected">
                                    ...
                                    <div class="col-sm-6 col-lg-3" id="basic">
                                        <div class="form-check mb-0 p-6">
                                            <input class="form-check-input" name="basic" type="checkbox"
                                                ...
                                                {{ $product->pharmacy_item_details?->is_basic == 1
                                                    ? 'checked'
                                                    : (isset($temp_product) && $temp_product == 1 && $product->basic == 1
                                                        ? 'checked'
                                                        : '') }}>
                                        ...
                                        <div class="col-sm-4 col-6">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="number" value="{{ $product->price }}" min="0"
                                                    max="999999999999.99" name="price" class="form-control"
                                                    step="0.01" placeholder="{{ translate('messages.Ex:') }} 100"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-sm-4 col-6">
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-body">
                <button type="button" class="close" data-dismiss="modal" onclick="foodModalClose()"
                    aria-label="Close">
                ...
                if (data.success) {
                    ...
                    setTimeout(function() {
                        if(data.is_approved==1){
                            location.href = '{{route('admin.store.view', [$product->store_id,'item'])}}';
                        }else{
