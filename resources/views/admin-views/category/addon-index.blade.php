...
@section('title', translate('messages.Add new add on category'))
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    {{ translate('messages.add_new_add_on_category') }}
                </span>
            </h1>
        </div>
        <!-- End Page Header --> 
                ...
                <form
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="price" class="form-control"
                            placeholder="{{ translate('messages.add_on_price') }}" value="{{ old('price') }}"
                            maxlength="191">
                    </div>
                    ...
                    @endif
                    <input name="position" value="3" hidden>
                    ...
                    <table id="columnSearchDatatable"
                        ...
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="border-0 text-center">{{ translate('messages.add_on_category') }}</th>
                                <th class="border-0 text-center">{{ translate('messages.add_on_price') }}</th>
                                    ...
                                    <td>
                                        <div class="btn--container justify-content-center">
                                            <a class="btn action-btn btn--primary btn-outline-primary"
                                                href="{{ route('admin.category.edit', [$category['id'],'Add On Category']) }}"
