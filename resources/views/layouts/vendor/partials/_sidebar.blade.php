                    ...
                    @if (\App\CentralLogics\Helpers::employee_module_permission_check('item'))
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('store-panel/item*') ? 'active' : '' }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                @if (\App\CentralLogics\Helpers::get_vendor_module_id() == 'services')
                                    <li
                                        class="nav-item {{ Request::is('store-panel/item/pending-list') ? 'active' : '' }}">
                                        <a class="nav-link " href="{{ route('vendor.item.pending_list') }}"
                                            title="{{ translate('messages.pending_list') }}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="text-truncate">{{ translate('messages.Pending_list') }}</span>
                                        </a>
                                    </li>
                                @endif
                    ...
                    @if (\App\CentralLogics\Helpers::employee_module_permission_check('store_setup'))
                        <li
                            ...
                            <a class="nav-link " href="{{ route('vendor.business-settings.store-setup') }}"
                                title="{{ translate('messages.store_config') }}">
                                <span class="tio-settings nav-icon"></span>
                                @if (\App\CentralLogics\Helpers::get_vendor_module_id() == 'services')
                                    <span class="text-truncate">{{ translate('messages.vendor_config') }}</span>
                                @else
                                    <span class="text-truncate">{{ translate('messages.store_config') }}</span>
                                @endif
                            </a>
                        </li>
                    @endif
