                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row g-2">
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="exampleFormControlSelect1">{{translate('messages.sub_sub_category')}}<span
                                                class="input-label-secondary"></span></label>
                                        <select name="sub_sub_category_id" id="sub-sub-categories" class="form-control js-select2-custom" onchange="getRequest('{{url('/')}}/store-panel/item/get-categories?parent_id='+this.value,'sub-sub-sub-categories')">
                                        </select>
                                    </div>
                                </div>                  
